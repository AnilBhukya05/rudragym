        ...
        <div className="container">
          <div className="two-col">
            ...
            <div className="rl">
              ...
              <div style={{ marginTop:28, borderRadius:14, overflow:"hidden", border:"1px solid rgba(255,255,255,0.07)", height:200 }}>
                <iframe
          ...
          <div className="rv" style={{ maxWidth:860, margin:"0 auto" }}>
            <div style={{ background:"linear-gradient(135deg,#141414,#0f0f0f)", border:"1px solid rgba(255,255,255,0.08)", borderRadius:20, overflow:"hidden", position:"relative" }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"auto 1fr" }}>
                <div style={{ padding:"44px 32px", background:"rgba(230,57,70,0.04)", borderRight:"1px solid rgba(255,255,255,0.06)", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minWidth:180, textAlign:"center" }}>
                  <div style={{ width:90, height:90, borderRadius:"50%", background:"linear-gradient(135deg,rgba(230,57,70,0.25),rgba(230,57,70,0.08))", border:"2px solid rgba(230,57,70,0.35)", display:"flex", alignItems:"center", justifyContent:"center", marginBottom:16, position:"relative" }}>
                    <span className="fd" style={{ fontSize:"2.2rem", color:"#E63946" }}>RV</span>
                    <div style={{ position:"absolute", bottom:2, right:2, width:22, height:22, borderRadius:"50%", background:"#E63946", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"0.7rem", border:"2px solid #141414" }}>✓</div>
                  </div>
                  <div className="fd" style={{ fontSize:"1.3rem", color:"#fff", marginBottom:4 }}>RUDRA VERMA</div>
                  <div style={{ fontSize:10, color:"#E63946", fontWeight:700, letterSpacing:"0.14em", textTransform:"uppercase", marginBottom:14 }}>Founder & Head Coach</div>
                  {[["🏆","NSCA Certified"],["🎓","Sports Science"],["📅","Since 2014"]].map(([ic,l])=>(
                    <div key={l} style={{ display:"flex", alignItems:"center", gap:7, fontSize:11.5, color:"#777", marginBottom:6 }}><span>{ic}</span><span>{l}</span></div>
                  ))}
                </div>
                <div style={{ padding:"40px 36px" }}>
                  ...
                  <p style={{ color:"#888", lineHeight:1.85, fontSize:14, marginBottom:14 }}>Rudra Verma founded Rudra Gym & Fitness Unisex in 2014 with a single mission: to bring world-class fitness to Warangal. Growing up as an athlete, he experienced firsthand how the right coaching and environment can transform not just a body, but an entire mindset.</p>
                  <p style={{ color:"#888", lineHeight:1.85, fontSize:14, marginBottom:14 }}>After earning his NSCA certification and a degree in Sports Science, Rudra returned to Warangal to build something the city had never seen — a premium, unisex training facility where every member is treated like an athlete.</p>
                  <p style={{ color:"#888", lineHeight:1.85, fontSize:14, marginBottom:24 }}>Over 10 years and 300+ transformations later, his philosophy remains unchanged: <em style={{ color:"#ccc" }}>"Train hard. Be consistent. Trust the process."</em></p>
                  <div style={{ display:"flex", gap:28, flexWrap:"wrap", paddingTop:20, borderTop:"1px solid rgba(255,255,255,0.07)" }}>
                    {[["10+","Years"],["300+","Transformations"],["30+","Staff"],["1","Elite Facility"]].map(([n,l])=>(
                      <div key={l}>
                        <div className="fd" style={{ fontSize:"1.8rem", color:"#E63946", lineHeight:1 }}>{n}</div>
              ...
              <div style={{ padding:"18px 32px", background:"rgba(230,57,70,0.05)", borderTop:"1px solid rgba(230,57,70,0.1)", display:"flex", alignItems:"center", gap:14 }}>
                <span style={{ fontSize:"1.8rem", color:"rgba(230,57,70,0.35)", fontFamily:"Georgia,serif", flexShrink:0 }}>"</span>
                <p style={{ fontSize:13.5, color:"#aaa", lineHeight:1.65, fontStyle:"italic" }}>We don't just build stronger bodies here — we build stronger people. Every member who walks through our doors deserves the best coaching, the best environment, and the belief that they can achieve more than they think.</p>
                <span style={{ fontSize:12, color:"#555", whiteSpace:"nowrap", flexShrink:0 }}>— Rudra Verma</span>
              </div>
            </div>
          </div>
        </div>
